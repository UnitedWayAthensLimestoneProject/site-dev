  		...
  		<div id="form_container">
			...
			<form id="form_code_of_conduct" method="POST" action="donationsform_consentform.php">
				...
				<table id="codeofconducttable">
					...
					<tr>
						<td><p>Once your donation form is processed, we will contact you to set up a meeting.<br>However, if you have any questions or concerns feel free to contact <b>Leigh Fogg at 256-233-2323.</b> Thank you!</p></td>
					</tr>
